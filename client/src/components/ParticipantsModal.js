...
import { CloseIcon, ContentCopyIcon } from "@mui/icons-material"
...
const ParticipantsModal = ({ show, close, id, receivingCall, callAccepted, answerCall, username, }) => {
  console.log("ran")
